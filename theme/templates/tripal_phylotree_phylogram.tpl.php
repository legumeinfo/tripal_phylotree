...
if ($phylotree->type_id->name != "taxonomy" and $phylotree->has_nodes) {
  ...
  <div id="phylogram">
	  <!-- d3js will add svg to this div, and remove the loader gif prefix with /
	  for absolute url -->
  ...
  <div id="phylonode_popup_dialog" style="display: none;">
	  ...
	  <div><a id="phylonode_go_link" href="?block=phylotree_go"
		       class="tripal_toc_list_item_link"  tabindex="-1">
		  View Gene Ontology</a></div>
	  <!-- removed tripal_toc_list_item_link from context link, at least while
	  it is a link off the site -->
	  <div><a id="phylonode_context_link" href="?block=phylotree_context"
		       class="" tabindex="-1">
      View Context</a></div>
  </div> <?php
}
